...
class CFF_Group_Posts{
	...
	*/
	 ...
	 *
	 * @since 3.19.3
	 * Returns Needed Information for the Group Posts Events Page
	 *
	 * @access public
	 */
	...
	static function check_duplicated_posts($prev_post, $ac_post){
			...
			$is_duplicate = (($prev_message == $ac_message) && ($prev_link == $ac_link) && ($prev_description == $ac_description) && !isset($ac_post->call_to_action->type)) ? true : false;
			return $is_duplicate;
	}
