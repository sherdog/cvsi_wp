...
class CFF_About {
	...
	public function __construct() {
		...
		self::$licenses_features = array(
			'entries'      => esc_html__( 'Feed Types', 'custom-facebook-feed' ),
			...
			'addons' => esc_html__( 'Filtering', 'custom-facebook-feed' ),
			//'marketing'    => esc_html__( 'Filtering', 'custom-facebook-feed' ),
			'marketing'     => esc_html__( 'Instagram Stories', 'custom-facebook-feed' ),
			'payments'      => esc_html__( 'Feed Moderation', 'custom-facebook-feed' ),
			'surveys'     => esc_html__( 'Header Display', 'custom-facebook-feed' ),
			'advanced'       => esc_html__( 'Post Linking', 'custom-facebook-feed' ),
	...
	protected function output_getting_started() {
		...
		<div class="cff-admin-about-section cff-admin-about-section-first-form" style="display:flex;">
			...
			<div class="cff-admin-about-section-first-form-video">
				<iframe src="https://www.youtube-nocookie.com/embed/0gykYq3JSrY" width="540" height="304" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			</div>
		...
		<?php if ( ! in_array( $license, self::$licenses_top, true ) ) { ?>
			<div class="cff-admin-about-section cff-admin-about-section-hero">
				...
				<div class="cff-admin-about-section-hero-main">
					<h2>
						<?php esc_html_e( 'Get Facebook Feed Pro and Unlock all the Powerful Features', 'custom-facebook-feed' ); ?>
					</h2>

					<p class="bigger">
						<?php
						echo wp_kses(
							__( 'Thanks for being a loyal Custom Facebook Feed Lite user. <strong>Upgrade to Custom Facebook Feed Pro</strong> to unlock all the awesome features and experience<br>why Custom Facebook Feed is the most popular Instagram plugin.', 'custom-facebook-feed' ),
							array(
								'br'     => array(),
								'strong' => array(),
							)
        ...
        <div class="cff-admin-about-section cff-admin-about-section-squashed cff-admin-about-section-post cff-admin-columns">
            ...
            <div class="cff-admin-column-80">
                ...
                <a href="https://smashballoon.com/custom-facebook-feed/docs/wordpress/?utm_source=WordPress&utm_medium=cff-about-page&utm_campaign=gettingstarted" target="_blank" rel="noopener noreferrer" class="cff-admin-about-section-post-link">
		...
		$data = array(
			'entries'      => array(
				'lite'  => array(
					'status' => 'partial',
					'text'   => array(
						'<strong>' . esc_html__( 'User feeds only', 'custom-facebook-feed' ) . '</strong>',
					),
				),
				'basic' => array(
					'status' => 'full',
			...
			'fields'       => array(
				'lite'  => array(
					'status' => 'partial',
					'text'   => array(
						'<strong>' . esc_html__( 'Grid layout only', 'custom-facebook-feed' ) . '</strong>',
					),
				),
				'basic' => array(
					'status' => 'full',
			...
			'marketing'    => array(
				...
				'pro'   => array(
					'status' => 'full',
					'text'   => array(
						'<strong>' . esc_html__( 'Display your latest Instagram story in a pop-up lightbox', 'custom-facebook-feed' ) . '</strong>',
					),
				),
			),
			'payments'     => array(
				...
				'pro'   => array(
					'status' => 'full',
					'text'   => array(
						'<strong>' . esc_html__( 'Visual moderation system for removing posts or creating a "white list" of selected posts', 'custom-facebook-feed' ) . '</strong>',
					),
				),
			),
			'surveys'      => array(
				'lite'  => array(
					'status' => 'partial',
					'text'   => array(
						'<strong>' . esc_html__( 'Standard or centered header', 'custom-facebook-feed' ) . '</strong>',
					),
				),
				'basic' => array(
					'status' => 'none',
				...
				'pro'   => array(
					'status' => 'full',
					'text'   => array(
						'<strong>' . esc_html__( 'Standard, centered, or boxed header that includes follower and post counts', 'custom-facebook-feed' ) . '</strong>',
					),
				),
			),
			'advanced'     => array(
				'lite'  => array(
					'status' => 'partial',
					'text'   => array(
						'<strong>' . esc_html__( 'Posts link to the same post on Instagram', 'custom-facebook-feed' ) . '</strong>',
					),
				),
				'basic' => array(
					'status' => 'partial',
				...
				'pro'   => array(
					'status' => 'full',
					'text'   => array(
						'<strong>' . esc_html__( 'Allow your posts to link to a URL in the caption or view in a lightbox', 'custom-facebook-feed' ) . '</strong>',
					),
				),
			),
			'addons'       => array(
				...
				'pro'   => array(
					'status' => 'full',
					'text'   => array(
						'<strong>' . esc_html__( 'Filter by word or hashtag', 'custom-facebook-feed' ) . '</strong>',
					),
				),
			),
			'support'      => array(
