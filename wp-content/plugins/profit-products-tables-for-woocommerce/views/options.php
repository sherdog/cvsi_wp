...
<br />
    <div style="display: flex; justify-content: space-between;">
        ...
        <div>
            ...
            <h2 class="woot-plugin-name"><?php printf(esc_html__('WOOT - WooCommerce Active Products Tables v.%s', 'profit-products-tables-for-woocommerce'), WOOT_VERSION) ?></h2>
        ...
        <div>
            ...
            if (time() > $start AND time() < $end):
                ?>
                <a href="https://codecanyon.pluginus.net/item/woot-woocommerce-products-tables/27928580" alt="40% off sale" target="_blank"><img width="400" src="<?php echo WOOT_LINK ?>assets/img/banners/off40sale-590x60.jpg" alt="40% off sale" /></a>
            <?php endif; ?>
        </div>
            ...
            <section id="tabs-main-help">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <!-- <?php
                        echo WOOT_HELPER::draw_html_item('a', [
                            'href' => 'https://products-tables.com/video-tutorials/',
                            'target' => '_blank',
                            'class' => 'woot-btn'
                ...
                <div>
                    <a href="https://products-filter.com/" title="WOOF - WooCommerce Products Filter" target="_blank"><img src="<?php echo WOOT_ASSETS_LINK ?>img/banners/woof-banner.jpg" width="250" alt="WOOF - WooCommerce Products Filter"></a>
                    &nbsp;<a href="https://currency-switcher.com/" title="WOOCS - WooCommerce Currency Switcher" target="_blank"><img src="<?php echo WOOT_ASSETS_LINK ?>img/banners/woocs-banner.jpg" width="250" alt="WOOCS - WooCommerce Currency Switcher"></a>
                    &nbsp;<a href="https://bulk-editor.com/" title="WOOBE - WooCommerce Bulk Editor and Products Manager Professional" target="_blank"><img src="<?php echo WOOT_ASSETS_LINK ?>img/banners/woobe-banner.jpg" width="250" alt="WOOBE - WooCommerce Bulk Editor and Products Manager Professional"></a>
                    &nbsp;<a href="https://wp.bulk-editor.com/" title="WPBE - WordPress Posts Bulk Editor Professional" target="_blank"><img src="<?php echo WOOT_ASSETS_LINK ?>img/banners/wpbe-banner.png" width="250" alt="WPBE - WordPress Posts Bulk Editor Professional"></a>
