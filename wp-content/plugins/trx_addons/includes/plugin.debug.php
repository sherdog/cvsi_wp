...
if (!function_exists('dcl')) {	function dcl($msg) {			if (!function_exists('is_user_logged_in') || is_user_logged_in()) echo '<pre>' . esc_html($msg) . '</pre>'; } }	// Console log - output any message on the screen
