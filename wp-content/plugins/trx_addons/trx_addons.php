...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '28.6.29.6' );
...
if ( !defined('TRX_ADDONS_PLUGIN_API') )		define('TRX_ADDONS_PLUGIN_API',	 'api/');
if ( !defined('TRX_ADDONS_PLUGIN_CPT') )		define('TRX_ADDONS_PLUGIN_CPT',	 'cpt/');
...
// Theme Activation Support
require_once TRX_ADDONS_PLUGIN_DIR . 'activation/activation.php';
// Third-party plugins support
require_once TRX_ADDONS_PLUGIN_DIR . 'api/js_composer/js_composer.php';	// Must be first
require_once TRX_ADDONS_PLUGIN_DIR . 'api/elementor/elementor.php';
...
require_once TRX_ADDONS_PLUGIN_DIR . 'api/custom-post-type-ui/custom-post-type-ui.php';
...
require_once TRX_ADDONS_PLUGIN_DIR . 'api/woocommerce-products-filter/woocommerce-products-filter.php';
...
// Importer
if (function_exists('trx_addons_is_theme_activated') && trx_addons_is_theme_activated()
) {
