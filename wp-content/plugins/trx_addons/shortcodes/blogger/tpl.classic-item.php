...
?><div <?php post_class( 'sc_blogger_item post_format_'.esc_attr($post_format) ); ?>><?php
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
									...
									apply_filters('trx_addons_filter_args_featured', array(
														...
														'hover' => 'zoomin',
														'thumb_size' => trx_addons_get_thumb_size($args['columns'] > 2 ? 'extra' : 'big')
														), 'team-classic')
								);
	...
	?><div class="sc_blogger_item_content entry-content"><?php
		...
		<div class="sc_blogger_item_excerpt">
                ...
                <?php }
                if (!isset($args['hide_meta']) || $args['hide_meta']==0) {
                    // Post meta
				...
				// More button
				if ( $show_more ) {
					?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="sc_button sc_button_default sc_button_size_normal"><?php esc_html_e('Read more', 'trx_addons'); ?></a></div><?php
				}
