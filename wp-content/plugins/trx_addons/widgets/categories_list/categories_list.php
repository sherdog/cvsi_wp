...
class trx_addons_widget_categories_list extends TRX_Addons_Widget {
	...
	function widget($args, $instance) {
        ...
        $no_margin = isset($instance['no_margin']) ? (int) $instance['no_margin'] : 0;
		...
		trx_addons_get_template_part(array(
                                        ...
                                        array_merge($args, compact('title', 'style', 'number', 'columns',
																	'show_posts', 'show_children', 'show_thumbs', 'no_margin',
	...
	function update($new_instance, $old_instance) {
		...
		$instance['no_margin'] = !empty($new_instance['no_margin']) ? 1 : 0;
	...
	function form($instance) {
		...
		$no_margin = (int) $instance['no_margin'];
