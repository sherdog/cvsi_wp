...
if ( !function_exists( 'trx_addons_sc_layouts_featured' ) ) {
	function trx_addons_sc_layouts_featured($atts, $content=null){	
		...
		trx_addons_get_template_part(array(
										'cpt/layouts/shortcodes/featured/tpl.'.trx_addons_esc($atts['type']).'.php',
										'cpt/layouts/shortcodes/featured/tpl.default.php'
										),
            ...
            protected function _register_controls() {
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'label_block' => false,
                        'type' => \Elementor\Controls_Manager::SELECT,
                        'options' => ! is_admin() ? array() : trx_addons_get_list_sc_aligns(true, false),
                        'default' => 'inherit'
                    ]
                );
