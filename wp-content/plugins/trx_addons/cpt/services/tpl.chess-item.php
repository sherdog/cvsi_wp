...
?>"><?php
	...
	<div class="sc_services_item_content">
		...
		<?php
			autoparts_show_post_meta( array(
					'components' => 'date',
					'counters' => '',
					'seo' => false,
					'echo' => true
			...
			//basekit_show_layout($basekit_post_meta);
		
		?>
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			<div class="sc_services_item_text"><?php echo mb_substr( strip_tags( get_the_excerpt() ), 0, 140 ).'...';?></div>
			<div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'trx_addons'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
