...
<div class="sc_team_item">
	...
	<div class="sc_team_item_info">
		...
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_default sc_button_size_normal"><?php esc_html_e('Learn more', 'trx_addons'); ?></a></div>
	</div>
</div>
<?php
