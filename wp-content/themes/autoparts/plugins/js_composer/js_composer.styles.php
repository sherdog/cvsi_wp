...
if ( !function_exists( 'autoparts_vc_get_css' ) ) {
	add_filter( 'autoparts_filter_get_css', 'autoparts_vc_get_css', 10, 4 );
	function autoparts_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.wpb-js-composer .vc_tta-color-grey.vc_tta-style-classic .vc_tta-panel:hover .vc_tta-panel-heading{
...
.vc_tta.vc_tta-accordion .vc_tta-panel-heading .vc_tta-panel-title > a:hover .vc_tta-controls-icon:before{
