...
.slider_swiper_outer a.slider_prev:hover,
.slider_swiper_outer a.slider_next:hover,
...
.sc_title_accent.color_style_link2.sc_title h1,
.sc_title_accent.color_style_link2.sc_title h2,
.sc_title_accent.color_style_link2.sc_title h3,
.sc_title_accent.color_style_link2.sc_title h4,
.sc_title_accent.color_style_link2.sc_title h5,
.sc_title_accent.color_style_link2.sc_title h6,
.sc_title_accent.color_style_link2.sc_title h1[class*="sc_title_"],
.sc_title_accent.color_style_link2.sc_title h1[class*="sc_title_"],
.sc_title_accent.color_style_link2.sc_title h3[class*="sc_title_"],
.sc_title_accent.color_style_link2.sc_title h4[class*="sc_title_"],
.sc_title_accent.color_style_link2.sc_title h5[class*="sc_title_"],
.sc_title_accent.color_style_link2.sc_title h6[class*="sc_title_"]{
	color: {$colors['text_dark']};
}
.sc_title_accent.color_style_link2.sc_title h1 i,
.sc_title_accent.color_style_link2.sc_title h2 i,
.sc_title_accent.color_style_link2.sc_title h3 i,
.sc_title_accent.color_style_link2.sc_title h4 i,
.sc_title_accent.color_style_link2.sc_title h5 i,
.sc_title_accent.color_style_link2.sc_title h6 i,
.sc_title_accent.color_style_link2.sc_title h1[class*="sc_title_"] i,
.sc_title_accent.color_style_link2.sc_title h1[class*="sc_title_"] i,
.sc_title_accent.color_style_link2.sc_title h3[class*="sc_title_"] i,
.sc_title_accent.color_style_link2.sc_title h4[class*="sc_title_"] i,
.sc_title_accent.color_style_link2.sc_title h5[class*="sc_title_"] i,
.sc_title_accent.color_style_link2.sc_title h6[class*="sc_title_"] i {
	color: {$colors['text_link2']};
}
...
.trx_addons_popup #trx_addons_register_content {
	background-color: {$colors['alter_bg_color']};
}
